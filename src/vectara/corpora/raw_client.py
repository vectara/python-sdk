...
class RawCorporaClient:
    ...
    def query_stream(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> typing.Iterator[HttpResponse[typing.Iterator[CorporaQueryStreamResponse]]]:
        """
        ...
        * Use advanced summarization options that utilize detailed summarization parameters such as `max_response_characters`, `temperature`, and `frequency_penalty` for generating precise and relevant summaries. [Learn more](https://docs.vectara.com/docs/api-reference/search-apis/search#advanced-summarization-options)
        ...
        with self._client_wrapper.httpx_client.stream(
            ...
            def _stream() -> HttpResponse[typing.Iterator[CorporaQueryStreamResponse]]:
                try:
                    if 200 <= _response.status_code < 300:
                            ...
                            for _sse in _event_source.iter_sse():
                                ...
                                try:
                                    yield typing.cast(
                                        ...
                                        parse_obj_as(
                                            type_=CorporaQueryStreamResponse,  # type: ignore
    ...
    def query(
        ...
        *,
        ...
        intelligent_query_rewriting: typing.Optional[bool] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[CorporaQueryResponse]:
        """
        Perform an advanced query on a specific corpus to find relevant results, highlight relevant snippets, and use Retrieval Augmented Generation.
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=CorporaQueryResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawCorporaClient:
    ...
    async def query_stream(
        ...
        *,
        ...
        intelligent_query_rewriting: typing.Optional[bool] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> typing.AsyncIterator[AsyncHttpResponse[typing.AsyncIterator[CorporaQueryStreamResponse]]]:
        """
        Perform an advanced query on a specific corpus to find relevant results, highlight relevant snippets, and use Retrieval Augmented Generation.
        ...
        * Use advanced summarization options that utilize detailed summarization parameters such as `max_response_characters`, `temperature`, and `frequency_penalty` for generating precise and relevant summaries. [Learn more](https://docs.vectara.com/docs/api-reference/search-apis/search#advanced-summarization-options)
        ...
        async with self._client_wrapper.httpx_client.stream(
            ...
            async def _stream() -> AsyncHttpResponse[typing.AsyncIterator[CorporaQueryStreamResponse]]:
                try:
                    if 200 <= _response.status_code < 300:
    ...
    async def query(
        ...
        *,
        ...
        intelligent_query_rewriting: typing.Optional[bool] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[CorporaQueryResponse]:
        """
        Perform an advanced query on a specific corpus to find relevant results, highlight relevant snippets, and use Retrieval Augmented Generation.
