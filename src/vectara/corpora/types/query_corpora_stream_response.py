...
class QueryCorporaStreamResponse_SearchResults(UniversalBaseModel):
    """
...
class QueryCorporaStreamResponse_GenerationChunk(UniversalBaseModel):
    """
    An individual event sent with Server-sent Events (SSE) when the query request is streamed.
    """
...
class QueryCorporaStreamResponse_GenerationEnd(UniversalBaseModel):
    """
    An individual event sent with Server-sent Events (SSE) when the query request is streamed.
    """
...
class QueryCorporaStreamResponse_FactualConsistencyScore(UniversalBaseModel):
    """
    An individual event sent with Server-sent Events (SSE) when the query request is streamed.
    """
...
class QueryCorporaStreamResponse_GenerationInfo(UniversalBaseModel):
    """
    An individual event sent with Server-sent Events (SSE) when the query request is streamed.
    """
...
class QueryCorporaStreamResponse_Error(UniversalBaseModel):
    """
    An individual event sent with Server-sent Events (SSE) when the query request is streamed.
    """
...
class QueryCorporaStreamResponse_End(UniversalBaseModel):
    """
    An individual event sent with Server-sent Events (SSE) when the query request is streamed.
    """
...
QueryCorporaStreamResponse = typing_extensions.Annotated[
    typing.Union[
