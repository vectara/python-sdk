...
class QueryCorpusRequest(UniversalBaseModel):
    """
    ...
    search: typing.Optional[QueryCorpusRequestSearch] = pydantic.Field(default=None)
    """
...
update_forward_refs(QueryCorpusRequest)
