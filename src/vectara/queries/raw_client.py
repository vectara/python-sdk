...
class RawQueriesClient:
    ...
    def query_stream(
    ...
    ) -> typing.Iterator[HttpResponse[typing.Iterator[QueriesQueryStreamResponse]]]:
        """
        ...
        * Customize citation formats in summaries using the `citations` object to include numeric, HTML, or Markdown links. [Learn more](https://docs.vectara.com/docs/api-reference/search-apis/search#citation-format-in-summary)
        ...
        with self._client_wrapper.httpx_client.stream(
            ...
            def _stream() -> HttpResponse[typing.Iterator[QueriesQueryStreamResponse]]:
                try:
                            ...
                            for _sse in _event_source.iter_sse():
                                ...
                                try:
                                    yield typing.cast(
                                        ...
                                        parse_obj_as(
                                            type_=QueriesQueryStreamResponse,  # type: ignore
    ...
    def query(
        ...
        *,
        ...
        intelligent_query_rewriting: typing.Optional[bool] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[QueriesQueryResponse]:
        """
        Perform a multipurpose query to retrieve relevant information from one or more corpora and generate a response using Retrieval Augmented Generation (RAG).
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=QueriesQueryResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
...
class AsyncRawQueriesClient:
    ...
    async def query_stream(
        ...
        *,
        ...
        intelligent_query_rewriting: typing.Optional[bool] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> typing.AsyncIterator[AsyncHttpResponse[typing.AsyncIterator[QueriesQueryStreamResponse]]]:
        """
        Perform a multipurpose query to retrieve relevant information from one or more corpora and generate a response using Retrieval Augmented Generation (RAG).
        ...
        * Customize citation formats in summaries using the `citations` object to include numeric, HTML, or Markdown links. [Learn more](https://docs.vectara.com/docs/api-reference/search-apis/search#citation-format-in-summary)
        ...
        async with self._client_wrapper.httpx_client.stream(
            ...
            async def _stream() -> AsyncHttpResponse[typing.AsyncIterator[QueriesQueryStreamResponse]]:
                try:
                    if 200 <= _response.status_code < 300:
    ...
    async def query(
        ...
        *,
        ...
        intelligent_query_rewriting: typing.Optional[bool] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[QueriesQueryResponse]:
        """
        Perform a multipurpose query to retrieve relevant information from one or more corpora and generate a response using Retrieval Augmented Generation (RAG).
